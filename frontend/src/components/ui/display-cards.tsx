...
interface DisplayCardProps {
  ...
  onClick?: () => void; // క్లిక్ చేస్తే పేజీ మారడానికి
}
...
function DisplayCard({
  ...
  return (
    ...
    >
      <div>
        <span className="relative inline-block rounded-full bg-blue-800/50 border border-blue-500/30 p-2 shadow-lg">
          {icon}
        </span>
        <p className={cn("text-xl font-bold ml-2", titleClassName)}>{title}</p>
      </div>
